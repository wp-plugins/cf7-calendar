...
Description: JavaScript Calendar for Content, Widget and also work for Contact Form 7. To use it just type [datetimepicker input-name-field] and [cf7cal input-name-field] inside cf7 form with input-name-field Unique!
...
add_filter('widget_text', 'page_text_filter', 1004 );
	...
	function cf7adminsettinghtml(){
		...
		$cf7setting = explode(";",cf7loadsetting()->option_value);
